 ...
 */
public class FABCoordinatorBehaviour extends AppBarLayout.ScrollingViewBehavior {

    public FABCoordinatorBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View child,
        ...
        } else if (dyConsumed == child.getMeasuredHeight() - child.getMeasuredHeight()) {
